...
- Plans are submitting PR into his mui-color project;
...
https://github.com/dmitrychebayewski/mui-color
...
Or using npm
```bash
npm add @dmitrychebayewski/mui-color
```
...
`@dmitrychebayewski/mui-color` bring 5 components.
